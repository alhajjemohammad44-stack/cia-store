        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-md mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-white/50 mt-2">Join CIA Store and start shopping</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center gap-2 text-sm text-white/40">
                <input type="checkbox" className="w-4 h-4 rounded border-white/10 bg-dark-100 accent-electric" required />
                <span>
                  I agree to the{' '}
                  <Link href="/terms" className="text-electric hover:text-electric-400">Terms of Service</Link>
                  {' '}and{' '}
                  <Link href="/privacy" className="text-electric hover:text-electric-400">Privacy Policy</Link>
                </span>
              </div>
            ...
            <p className="text-center text-sm text-white/40 mt-6">
              ...
              <Link href="/auth/login" className="text-electric hover:text-electric-400 font-bold transition-colors">
                Sign In
              </Link>
            </p>
          </div>
